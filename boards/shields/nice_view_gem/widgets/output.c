...
static void draw_usb_connected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_img(canvas, 45, 6, &usb, &img_dsc);
}
...
static void draw_ble_unbonded(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_img(canvas, 44, 4, &bt_unbonded, &img_dsc);
}
#endif
...
static void draw_ble_disconnected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_img(canvas, 49, 4, &bt_no_signal, &img_dsc);
}
...
static void draw_ble_connected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_img(canvas, 49, 4, &bt, &img_dsc);
}
